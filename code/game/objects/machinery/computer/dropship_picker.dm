...
/obj/machinery/computer/dropship_picker/calico
	name = "SOM dropship picker"
	desc = "A computer that lets you choose the model of the Calico.."
	density = TRUE
	icon_state = "computer"
	screen_overlay = "computer_generic"
	circuit = null
	...
	req_access = list()
	/// dock id to dock our chosen shuttle at
	var/dock_id = SHUTTLE_SOMTADPOLE
	///if true lock console
	var/dropship_selected = FALSE
	///currently chosen ref to a template from tgui
	var/current_template_ref
